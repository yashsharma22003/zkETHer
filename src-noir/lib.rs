...
mod noir_tests {
    ...
    fn test_noir_multiplier2() {
        ...
        let circuit_inputs =  vec![
            "21044526501566040117993124035879025401502295415862399375555023304404664663033".to_string(),
            "10521653044715741213389587207869002198029238622411268305570738397091138096268".to_string(),
            "15325408734600337950919883019972309724979760076380211312928044044232344243185".to_string()
        ];
